namespace PictureColorDiffusion
{
	partial class MainForm
	{
        ...
        private void InitializeComponent()
        {
            ...
            checkBoxYoloEdgeDetection = new CheckBox();
            ...
            // groupBoxInference
            // 
            groupBoxInference.Controls.Add(checkBoxYoloEdgeDetection);
            ...
            // 
            // checkBoxYoloEdgeDetection
            // 
            checkBoxYoloEdgeDetection.AutoSize = true;
            checkBoxYoloEdgeDetection.Checked = true;
            checkBoxYoloEdgeDetection.CheckState = CheckState.Checked;
            checkBoxYoloEdgeDetection.ForeColor = Color.WhiteSmoke;
            checkBoxYoloEdgeDetection.Location = new Point(177, 76);
            checkBoxYoloEdgeDetection.Name = "checkBoxYoloEdgeDetection";
            checkBoxYoloEdgeDetection.Size = new Size(179, 21);
            checkBoxYoloEdgeDetection.TabIndex = 123;
            checkBoxYoloEdgeDetection.Text = "YoloV8 Smooth Masks";
            toolTip1.SetToolTip(checkBoxYoloEdgeDetection, "Will take the masks detected by the Yolo Segmentation model and crop it so it matches the closest Edges in the mask.\r\nThe goal is the get a more linear / curvy maské");
            checkBoxYoloEdgeDetection.UseVisualStyleBackColor = true;
            // 
            // labelSteps
            // 
        ...
        private CheckBox checkBoxYoloEdgeDetection;
    }
}
